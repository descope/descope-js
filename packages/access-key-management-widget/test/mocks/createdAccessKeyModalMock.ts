...
<descope-container data-editor-type="container" direction="column" id="ROOT" space-between="md" st-horizontal-padding="0rem" st-vertical-padding="0rem" st-align-items="start" st-justify-content="safe center" st-background-color="#80808000" st-host-width="100%" st-gap="0.5rem">
  ...
  <descope-text-field bordered="true" full-width="true" id="generated-key" label="" max="100" name="generated-key" placeholder="Generated Key" required="true" size="sm" readonly data-testid="created-access-key-input"></descope-text-field>
  <descope-container data-editor-type="container" direction="row" id="buttonsContainer" st-horizontal-padding="0rem" st-vertical-padding="0rem" st-align-items="start" st-justify-content="flex-end" st-background-color="#ffffff00" st-host-width="100%" st-gap="0rem">
    <descope-button data-id="modal-close" data-testid="created-access-key-modal-close" data-type="button" formNoValidate="false" full-width="false" id="createdAccessKeyCancelButton" shape="" size="xs" variant="contained" mode="primary" square="false">Copy to clipboard & close</descope-button>
  </descope-container>
</descope-container>
`;
