...
>
  ...
  >
    ...
    <descope-container
      data-id="tenant-admin-link-sso-row"
      data-editor-type="container"
      id="isG9wyAH3S"
      st-items-grow="1"
      direction="row"
    ...
    <descope-container
      ...
      st-host-width="100%"
    >
      <descope-button data-id="tenant-sso-add-button">Add new</descope-button>
      <descope-container data-id="tenant-sso-create-form" hidden direction="column">
        <input data-id="tenant-sso-create-name" type="text" placeholder="Okta — Production" />
        <input data-id="tenant-sso-create-id" type="text" />
        <descope-button data-id="tenant-sso-create-submit">Add configuration</descope-button>
        <descope-button data-id="tenant-sso-create-cancel">Cancel</descope-button>
      </descope-container>
      <descope-container data-id="tenant-sso-configurations-list" direction="column"></descope-container>
    </descope-container>
  </descope-container>
</descope-container>
`;
