...
<descope-container data-editor-type="container" direction="column" id="ROOT" space-between="md" st-horizontal-padding="0rem" st-vertical-padding="0rem" st-align-items="start" st-justify-content="safe center" st-background-color="#80808000" st-host-width="100%" st-gap="0.75rem">
   ...
   <descope-email-field bordered="true" data-errormessage-pattern-mismatch="Must be a valid email" full-width="true" id="recoveryEmailInput" label="Recovery Email" max="100" name="recoveryEmail" placeholder="" required="false" size="sm"></descope-email-field>
   <descope-phone-field bordered="true" data-errormessage-pattern-mismatch-too-short="Please enter a valid phone" default-code="autoDetect" full-width="true" id="recoveryPhoneInput" label="Recovery Phone" maxlength="20" minlength="6" name="recoveryPhone" phone-input-placeholder="" size="sm" type="tel"></descope-phone-field>
