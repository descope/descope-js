import { S as State, _ as __classPrivateFieldGet, a as __classPrivateFieldSet } from './index-e76ada1f.js';
...
const addOnResize = (ele) => {
    // eslint-disable-next-line no-param-reassign
    ele.onmousemove = (e) => {
        if ((e.target.w && e.target.w !== e.target.offsetWidth) ||
...
class Debugger extends HTMLElement {
    ...
    connectedCallback() {
        dragElement(__classPrivateFieldGet(this, _Debugger_rootEle, "f"), __classPrivateFieldGet(this, _Debugger_headerEle, "f"), { top: 'all', bottom: 100, left: 100, right: 100 });
...
_Debugger_messagesState = new WeakMap(), _Debugger_rootEle = new WeakMap(), _Debugger_contentEle = new WeakMap(), _Debugger_headerEle = new WeakMap(), _Debugger_eventsCbRefs = new WeakMap(), _Debugger_instances = new WeakSet(), _Debugger_onNewMessages = function _Debugger_onNewMessages(data) {
  ...
  `)
    ...
    __classPrivateFieldGet(this, _Debugger_contentEle, "f").querySelectorAll('.msg').forEach((ele) => {
