...
export type ReplaceParam<Args extends readonly any[], Idx extends keyof Args, NewType> = {
...
export type BeforeRequestHook = Extract<CoreSdkConfig['hooks']['beforeRequest'], Function>;
