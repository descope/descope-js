...
describe('Enchanted Link', () => {
	...
	describe('signUp', () => {
		it('should throw an error when loginId is not a string', () => {
			expect(() => sdk.enchantedLink.signUp(undefined)).toThrow('"loginId" must be a string');
		});

		it('should throw an error when loginId is empty', () => {
			expect(() => sdk.enchantedLink.signUp('')).toThrow('"loginId" must not be empty');
		});
		...
		it('should send the correct request', () => {
			...
			expect(mockHttpClient.post).toHaveBeenCalledWith(apiPaths.enchantedLink.signUp + '/email', {
				loginId: 'loginId',
		...
		it('should return the correct response', async () => {
			...
			const resp = await sdk.enchantedLink.signUp('loginId', 'http://some.thing.com', {
				name: 'John Doe'
			});
	...
	describe('signIn', () => {
		it('should throw an error when loginId is not a string', () => {
			expect(() => sdk.enchantedLink.signUp(undefined, 'http://some.thing.com')).toThrow(
				'"loginId" must be a string'
			);
		});

		it('should throw an error when loginId is empty', () => {
			expect(() => sdk.enchantedLink.signUp('', 'http://some.thing.com')).toThrow(
		...
		it('should return the correct response', async () => {
			...
			mockHttpClient.post.mockResolvedValue(httpResponse);
			const resp = await sdk.enchantedLink.signIn('loginId', 'http://some.thing.com');
	...
	describe('signUpOrIn', () => {
		it('should throw an error when loginId is not a string', () => {
			expect(() => sdk.enchantedLink.signUpOrIn(undefined, 'http://some.thing.com')).toThrow(
				'"loginId" must be a string'
			);
		});

		it('should throw an error when loginId is empty', () => {
			expect(() => sdk.enchantedLink.signUpOrIn('', 'http://some.thing.com')).toThrow(
				'"loginId" must not be empty'
			);
		});
		...
		it('should return the correct response', async () => {
			...
			mockHttpClient.post.mockResolvedValue(httpResponse);
			const resp = await sdk.enchantedLink.signUpOrIn('loginId', 'http://some.thing.com');
	...
	describe('verify', () => {
		...
		it('should throw an error when token is empty', () => {
			expect(() => sdk.enchantedLink.verify('')).toThrow('"token" must not be empty');
		});

		it('should send the correct request', () => {
			sdk.enchantedLink.verify('123456');
			expect(mockHttpClient.post).toHaveBeenCalledWith(apiPaths.enchantedLink.verify, {
				token: '123456'
			});
		});
	...
	describe('waitForSession', () => {
		it('should throw an error when pendingRef is not a string', () => {
			expect(sdk.enchantedLink.waitForSession).toThrow('"pendingRef" must be a string');
		});

		it('should throw an error when pendingRef is empty', () => {
			expect(() => sdk.enchantedLink.waitForSession('')).toThrow('"pendingRef" must not be empty');
		});
		...
		it('should send the correct request', async () => {
			...
			expect(mockHttpClient.post).toHaveBeenCalledWith(apiPaths.enchantedLink.session, {
	...
	describe('update', () => {
		describe('email', () => {
			...
			it('should throw an error when email is not in email format', () => {
				expect(() => sdk.enchantedLink.update.email('loginId', 'nonEmail')).toThrow(
