...
describe('webauthn', () => {
	...
	describe('signUp', () => {
		describe('start', () => {
			...
			it('should throw an error when origin is not a string', () => {
				expect(() => sdk.webauthn.signUp.start('loginId')).toThrow('"origin" must be a string');
			});
			...
			it('should send the correct request', () => {
				...
				expect(mockHttpClient.post).toHaveBeenCalledWith(apiPaths.webauthn.signUp.start, {
			...
			it('should return the correct response', async () => {
				...
				const resp = await sdk.webauthn.signUp.start('loginId', 'origin', 'John Doe');
		...
		describe('finish', () => {
			it('should throw an error when transactionId is not a string', () => {
				expect(sdk.webauthn.signUp.finish).toThrow('"transactionId" must be a string');
			});

			it('should throw an error when transactionId is empty', () => {
				expect(() => sdk.webauthn.signUp.finish('')).toThrow('"transactionId" must not be empty');
			});
			...
			it('should send the correct request', () => {
				...
				expect(mockHttpClient.post).toHaveBeenCalledWith(apiPaths.webauthn.signUp.finish, {
			...
			it('should return the correct response', async () => {
				...
				const resp = await sdk.webauthn.signUp.finish('transactionId', 'response');
	...
	describe('signIn', () => {
		describe('start', () => {
			...
			it('should throw an error when origin is not a string', () => {
				expect(() => sdk.webauthn.signIn.start('loginId')).toThrow('"origin" must be a string');
			});
		...
		describe('finish', () => {
			...
			it('should send the correct request', () => {
				...
				expect(mockHttpClient.post).toHaveBeenCalledWith(apiPaths.webauthn.signIn.finish, {
					transactionId: 'transactionId',
					response: 'response'
				});
			});
			...
			it('should return the correct response', async () => {
				...
				const resp = await sdk.webauthn.signIn.finish('transactionId', 'response');
	...
	describe('signUpOrIn', () => {
		describe('start', () => {
			it('should throw an error when loginId is not a string', () => {
				expect(sdk.webauthn.signUpOrIn.start).toThrow('"loginId" must be a string');
			});
			...
			it('should throw an error when origin is not a string', () => {
				expect(() => sdk.webauthn.signUpOrIn.start('loginId')).toThrow('"origin" must be a string');
			});
			...
			it('should send the correct request', () => {
				...
				expect(mockHttpClient.post).toHaveBeenCalledWith(apiPaths.webauthn.signUpOrIn.start, {
					loginId: 'loginId',
					origin: 'origin'
				});
			});
	...
	describe('add', () => {
		describe('start', () => {
			...
			it('should throw an error when origin is not a string', () => {
				expect(() => sdk.webauthn.update.start('loginId')).toThrow('"origin" must be a string');
			});
			...
			it('should return the correct response', async () => {
				...
				const resp = await sdk.webauthn.update.start('loginId', 'origin', 'token');
		...
		describe('finish', () => {
			...
			it('should send the correct request', () => {
				...
				expect(mockHttpClient.post).toHaveBeenCalledWith(apiPaths.webauthn.update.finish, {
					transactionId: 'transactionId',
					response: 'response'
				});
			});
