...
export default authMiddleware({
	...
	// Defaults to process.env.NEXT_DESCOPE_PROJECT_ID
...
- **projectId:** The Descope Project ID. If not provided, the function will fall back to `NEXT_DESCOPE_PROJECT_ID` from the environment variables.
